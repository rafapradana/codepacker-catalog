      ...
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-10">
            ...
            <h2 className="text-[28px] md:text-[32px] font-bold text-gray-900 mb-3 leading-tight font-poppins">
              Top Students
            </h2>
            <p className="text-[14px] text-gray-600 max-w-2xl mx-auto leading-relaxed font-inter">
            ...
            {topStudents.map((student) => (
              <div key={student.id} className="bg-white border border-gray-200 rounded-xl p-5 hover:shadow-lg transition-all duration-300">
                ...
                <div className="text-center mb-3">
                  <h3 className="text-[16px] font-bold text-gray-900 mb-0.5 font-poppins">
                    {student.name}
                  </h3>
                  <p className="text-[12px] text-gray-600 font-medium font-inter">
                    {student.class}
                  </p>
                </div>

                {/* Bio */}
                <p className="text-[12px] text-gray-600 text-center mb-4 line-clamp-2 leading-relaxed font-inter">
                  {student.bio}
                </p>

                {/* Skills */}
                <div className="mb-4">
                  <div className="text-[11px] font-bold text-gray-900 mb-2 font-poppins">Skills</div>
                ...
                <div className="flex items-center justify-between mb-4 pb-4 border-b border-gray-100">
                  ...
                  <div className="flex items-center text-gray-600">
                    ...
                    <span className="text-[12px] font-medium font-inter">{student.totalViews.toLocaleString()} views</span>
                  </div>
                </div>

                {/* Actions */}
                <div className="space-y-2">
                  <button className="w-full flex items-center justify-center px-3 py-1.5 border border-gray-300 rounded-lg text-[12px] font-medium text-gray-700 hover:bg-gray-50 transition-colors font-inter">
                    <Github className="w-3 h-3 mr-1.5" />
                    GitHub
                  </button>
                  <Button asChild className="w-full rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-[12px] py-1.5 h-auto font-inter">
          ...
          <div className="text-center">
            <Button asChild variant="outline" size="lg" className="rounded-lg px-6 font-inter">
